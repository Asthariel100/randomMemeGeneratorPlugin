...
Plugin Name: Meme_Api
 
Plugin URI: https://memeApi.com/
 
Description: Plugin to accompany MemeApi guide to creating plugins
 
Version: 1.0
 
Author: Yohann Fallas
 
Author URI: https://memeapi.com/
 
License: GPLv2 or later
 
Text Domain: meme api random
...
function wpm_custom_post_type() {
    ...
    register_post_type( 'RandomMeme', $args );
